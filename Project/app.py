...
def main():
    ...
    height = st.number_input("height in inches", min_value=0.0)
    weight = st.number_input("weight in lbs ", min_value=0)
    bmi = st.number_input("bmi", min_value=0.0)
    waist = st.number_input("waist in inches", min_value=0.0)
    hip = st.number_input("hip in inches", min_value=1.0)
